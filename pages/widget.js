        ...
        <div style={styles.grid}>
          {cells.map((post, i) => (
            <div
              ...
              onDragEnd={onDragEnd}
              onClick={() => post && !isCanvaUrl(post.imageUrl) && setPreview(post)}
            >
              {post ? (
                <>
                  {post.imageUrl && isCanvaUrl(post.imageUrl) ? (
                    <div style={styles.canvaWrapper}>
                      ...
                      />
                      <div
                        style={styles.canvaClickOverlay}
        ...
        <div style={styles.modalBg} onClick={() => setPreview(null)}>
          <div style={styles.modal} onClick={e => e.stopPropagation()}>
            ...
            {preview.imageUrl && isCanvaUrl(preview.imageUrl) ? (
              <div style={{ position: 'relative', width: '100%', aspectRatio: '1', background: '#f3f4f6' }}>
                <iframe
            ...
            <div style={styles.modalInfo}>
              ...
              <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginTop: 8 }}>
                <span style={{
                  ...
                  color: STATUS_CONFIG[preview.status].color
                }}>
...
const styles = {
  ...
  canvaWrapper: { position: 'absolute', inset: 0, overflow: 'hidden' },
  canvaIframe: { width: '300%', height: '300%', border: 'none', transform: 'scale(0.333)', transformOrigin: 'top left', pointerEvents: 'none' },
  canvaClickOverlay: { position: 'absolute', inset: 0, cursor: 'pointer', zIndex: 2 },
  ...
  placeholder: { width: '100%', height: '100%', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 4, background: '#f9fafb' },
